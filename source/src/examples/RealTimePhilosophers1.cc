...
// Last Modified On : Sun Jul 18 11:11:34 2010
// Update Count     : 100
// 
...
_Mutex<uPriorityQ,uPriorityQ> class RestRoom {
  public:
...
_Mutex<uPriorityQ,uPriorityQ> _PeriodicTask<uPIHeap> Philosopher {
    uDuration C1, C2;
    int id;
...
// Local Variables: //
// compile-command: "u++ RealTimePhilosophers1.cc" //
// End: //
