...
%% Last Modified On : Tue Sep 13 07:53:58 2016
%% Update Count     : 6897
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The ESM server conditionally inserts the string into the future by checking if the future at position \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{value}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{NULL}}}\endlgrinde\LGend{} indicating it has been cancelled.
...
\L{\LB{\0\0\0\0\K{enum}\0\{\0\V{DefaultWorkers}\0=\016,\0\V{DefaultProcessors}\0=\02\0\};}}
\L{\LB{\0\0\K{public}:}}
...
\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\V{Cluster}\0\V{clus}\0=\0\V{Same}\0);}}
\L{\LB{\0\0\0\0\K{template}\0\<\K{typename}\0\V{Func}\>\0\K{void}\0\V{send}(\0\V{Func}\0\V{action}\0);}}
\L{\LB{\0\0\0\0\K{template}\0\<\K{typename}\0\V{Func}\>\0\K{auto}\0\V{sendrecv}(\0\V{Func}\0\V{action}\0)\0\-\>\0\V{Future\_ISM}\<\V{decltype}(\V{action}())\>;}}
\L{\LB{\};}}
\endlgrinde\LGend
...
\begin{sloppypar}
-- creates an executor containing a work queue, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{DefaultWorkers}}}\endlgrinde\LGend{} worker threads, running on \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{DefaultProcessors}}}\endlgrinde\LGend{} processors, which are created on the current cluster with the cluster's default stack\index{stack!default size} size.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uExecutor}(\0\V{Cluster}\0\V{clus}\0)}}\endlgrinde\LGend{}]
-- creates an executor containing a work queue, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{DefaultWorkers}}}\endlgrinde\LGend{} worker threads, running on \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{DefaultProcessors}}}\endlgrinde\LGend{} processors, which are created on the current or separate cluster with the cluster's default stack\index{stack!default size} size.
...
-- creates an executor containing a work queue, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nworkers}}}\endlgrinde\LGend{} worker threads, running on \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{DefaultProcessors}}}\endlgrinde\LGend{} processors, which are created on the current or separate cluster with the cluster's default stack\index{stack!default size} size.
...
-- creates an executor containing a work queue, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nworkers}}}\endlgrinde\LGend{} worker threads, running on \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nprocessors}}}\endlgrinde\LGend{} processors, which are created on the current or separate cluster with the cluster's default stack\index{stack!default size} size.
\end{sloppypar}
\end{prefix}
...
\L{\LB{}\Tab{4}{\K{return}\03;}\Tab{56}{\C{}\1\1\0preform\0work\0and\0return\0result}}
\CE{}\L{\LB{\}}}
...
\CE{}\L{\LB{}\Tab{8}{\K{return}\0\V{val};}\Tab{56}{\C{}\1\1\0preform\0work\0and\0return\0result}}
\CE{}\L{\LB{}\Tab{4}{\}}}
...
\L{\LB{\Proc{osacquire}}\Tab{4}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\-1\0\<\<\0\V{endl};}\Tab{56}{\C{}\1\1\0preform\0work\0and\0no\0result}}
\CE{}\L{\LB{\}}}
...
\CE{}\L{\LB{}\Tab{8}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\V{val}\0\<\<\0\V{endl};}\Tab{56}{\C{}\1\1\0preform\0work\0and\0no\0result}}
\CE{}\L{\LB{}\Tab{4}{\}}}
...
\CE{}\L{\LB{}\Tab{4}{\V{Future\_ISM}\<\K{int}\>\0\V{fi}[10];}}
\L{\LB{}\Tab{4}{\V{Future\_ISM}\<\K{double}\>\0\V{fd}[10];}}
\L{\LB{}\Tab{4}{\V{Future\_ISM}\<\K{char}\>\0\V{fc}[10];}}
\L{\LB{}}
\L{\LB{\Proc{for}}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\010;\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0send\0off\0work\0for\0executor}}
...
\CE{}\L{\LB{}\Tab{4}{\V{executor}.\V{send}(\0\V{routine2}\0);}\Tab{56}{\C{}\1\1\0send\0off\0work\0but\0no\0return\0value}}
...
\L{\LB{\Proc{for}}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\010;\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0wait\0for\0results}}
...
\end{list}
\uC requires at least GNU~\cite{GNU-C++}\index{GNU C++@GNU \CC} g++-4.5.0 or greater.
