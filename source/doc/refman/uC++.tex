...
%% Last Modified On : Tue Dec 27 09:00:36 2016
%% Update Count     : 7252
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\L{\LB{\0\0\0\0\K{enum}\0\V{State}\0\{\0\V{Start},\0\V{Inactive},\0\V{Active},\0\V{Halt}\0\};}}
...
\L{\LB{}\Tab{4}{\K{if}\0(\0\V{N}\0!=\00\0)\0\{}}
...
\CE{}\L{\LB{}\Tab{4}{\V{COFOR}(\0\V{row},\00,\0\V{rows},}\Tab{28}{\C{}\1\1\0for\0(\0int\0row\0=\00;\0row\0\<\0rows;\0row\0+=\01\0)}}
\CE{}\L{\LB{}\Tab{8}{\V{subtotals}[\V{row}]\0=\00;}\Tab{28}{\C{}\1\1\0row\0is\0loop\0number}}
\CE{}\L{\LB{}\Tab{8}{\K{for}\0(\0\K{int}\0\V{c}\0=\00;\0\V{c}\0\<\0\V{cols};\0\V{c}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{8}{\0\0\0\0\V{subtotals}[\V{row}]\0+=\0\V{matrix}[\V{row}][\V{c}];}}
\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{4}{);\0\C{}\1\1\0wait\0for\0threads}}
\CE{}\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{r}\0=\00;\0\V{r}\0\<\0\V{rows};\0\V{r}\0+=\01\0)\0\{}}
...
\CE{}\L{\LB{}\Tab{4}{\K{while}(\0\V{TestSet}(\0\V{Lock}\0)\0);}}
...
\CE{}\L{\LB{}}
\L{\LB{\K{void}\0\V{Task}::\V{main}()\0\{\0}\Tab{32}{\C{}\1\1\0each\0task\0does}}
\CE{}\L{\LB{}\Tab{4}{\K{while}(\0\V{uFetchAssign}(\0\V{Lock}\0)\0==\0\V{CLOSED}\0);}}
\L{\LB{}\Tab{4}{\C{}\1\1\0critical\0section}}
...
\CE{}\L{\LB{}}
\L{\LB{\K{void}\0\V{Task}::\V{main}()\0\{\0}\Tab{32}{\C{}\1\1\0each\0task\0does}}
\CE{}\L{\LB{}\Tab{4}{\K{while}(\0\V{uFetchAdd}(\0\V{Lock}\0)\0!=\01\0);}}
\L{\LB{}\Tab{4}{\C{}\1\1\0critical\0section}}
...
\CE{}\L{\LB{}}
\L{\LB{\K{void}\0\V{Task}::\V{main}()\0\{\0}\Tab{32}{\C{}\1\1\0each\0task\0does}}
\CE{}\L{\LB{\Proc{while}}\Tab{4}{\K{while}(\0\V{uCompareAssign}(\0\V{Lock},\0\V{OPEN},\0\V{CLOSED}\0)\0);}}
\L{\LB{}\Tab{4}{\C{}\1\1\0critical\0section}}
\CE{}\L{\LB{}\Tab{4}{\V{uFetchAssign}(\0\V{CLOSED}\0);}}
\L{\LB{\}}}
\endlgrinde\LGend
...
\CE{}\L{\LB{\0\0\K{public}:}}
\L{\LB{\Proc{CoProcessorCxt}}\Tab{4}{\V{CoProcessorCxt}()\0:\0\V{uContext}(\0\&\V{uUniqueKey}\0)\0\{\};}}
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{\Proc{Derived}}\Tab{4}{\V{Derived}(\0\K{int}\0\V{i}\0)\0:\0\V{Base}(\0\V{i},\03.0,\0\S{}\'c\'\SE{}\0);}\Tab{44}{\C{}\1\1\0values\03.0\0and\0\'c\'\0must\0be\0specified}}
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
...
\CE{}\L{\LB{\Proc{osacquire}}\Tab{4}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\V{f}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{}\0\<\<}\Tab{44}{\C{}\1\1\0may\0block\0on\0first\0attempt\0to\0retrieve\0value}}
...
\L{\LB{\Proc{if}}\Tab{4}{\K{if}\0(\0\V{f1}.\V{available}()\0)\0\{}}
...
\L{\LB{}\Tab{12}{\K{if}\0(\0\V{requests}[\V{value}]\0!=\0\V{nullptr}\0)\0\{}}
\L{\LB{}\Tab{16}{\V{requests}[\V{value}]\-\>\V{delivery}(\0\V{text}\0);}}
\L{\LB{}\Tab{12}{\}}}
\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{4}{\}\0\C{}\1\1\0input}}
\CE{}\L{\LB{\0\0\K{public}:}}
\L{\LB{\Proc{InputServer}}\Tab{4}{\V{InputServer}()\0:\0\V{iw}(\0\*\K{this}\0)\0\{\}}}
\L{\LB{}}
...
\L{\LB{\0\0\0\0\K{enum}\0\{\0\V{DefaultWorkers}\0=\016,\0\V{DefaultProcessors}\0=\04\0\};}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{\0\0\0\0\K{enum}\0\V{Cluster}\0\{\0\V{Same},\0\V{Sep}\0\};}\Tab{44}{\C{}\1\1\0use\0same\0or\0separate\0cluster}}
\CE{}\L{\LB{\0\0\0\0\V{uExecutor}();}}
\L{\LB{\0\0\0\0\V{uExecutor}(\0\V{Cluster}\0\V{clus}\0);}}
\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\V{Cluster}\0\V{clus}\0=\0\V{Same}\0);}}
\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{int}\0\V{affOffset}\0=\0\-1,\0\V{Cluster}\0\V{clus}\0=\0\V{Same}\0);}}
\L{\LB{\0\0\0\0\K{template}\<\0\K{typename}\0\V{Func}\0\>\0\K{void}\0\V{send}(\0\V{Func}\0\V{action}\0);}}
\L{\LB{\0\0\0\0\K{template}\<\0\K{typename}\0\V{Func}\0\>\0\K{auto}\0\V{sendrecv}(\0\V{Func}\0\V{action}\0)\0\-\>\0\V{Future\_ISM}\<\0\V{decltype}(\V{action}())\0\>;}}
\L{\LB{\};}}
\endlgrinde\LGend
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{int}\0\V{affOffset}\0=\0\-1,\0\V{Cluster}\0\V{clus}\0=\0\V{Same}\0)}}\endlgrinde\LGend{}]
...
Otherwise, the processors are run on an CPUs selected by the operating system.
\end{sloppypar}
\end{prefix}
...
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\Proc{Functor}}\Tab{4}{\V{Functor}(\0\K{double}\0\V{val}\0)\0:\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\}\0\V{functor}(\04.5\0);}}
\L{\LB{}}
\L{\LB{\K{void}\0\V{routine2}()\0\{}}
\L{\LB{\Proc{osacquire}}\Tab{4}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\-1\0\<\<\0\V{endl};}\Tab{56}{\C{}\1\1\0perfom\0work\0and\0no\0result}}
\CE{}\L{\LB{\}}}
...
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\Proc{Functor2}}\Tab{4}{\V{Functor2}(\0\K{double}\0\V{val}\0)\0:\0\V{val}(\0\V{val}\0)\0\{\}}}
...
\L{\LB{}}
\L{\LB{\Proc{for}}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\0\V{NoOfRequests};\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0send\0off\0work\0for\0executor}}
...
\L{\LB{\Proc{for}}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\0\V{NoOfRequests};\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0wait\0for\0results}}
\CE{}\L{\LB{}\Tab{8}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\V{fi}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{}\0\<\<\0\V{fd}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{}\0\<\<\0\V{fc}[\V{i}]()\0\<\<\0\S{}\"\0\"\SE{};}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\Proc{osacquire}}\Tab{4}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\V{endl};}}
\L{\LB{\}}}
\endlgrinde\LGend
...
\CE{}\L{\LB{}\Tab{4}{\K{static}\0\K{struct}\0\V{StopMsg}\0:\0\K{public}\0\V{uActor}::\V{Message}\0\{\}\0\V{stopMsg};\0\C{}\1\1\0for\0termination}}
...
\L{\LB{}\Tab{8}{\V{Unhandled}(\0\V{Message}\0\*\0\V{msg}\0)\0:\0\V{msg}(\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\};}}
\L{\LB{\};}}
\endlgrinde\LGend
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\Proc{Case}}\Tab{4}{\V{Case}(\0\V{FMsg},\0\V{msg}\0)\0\{}\Tab{56}{\C{}\1\1\0FutureMessage\0FMsg\0?}}
...
\CE{}\L{\LB{}\Tab{8}{\V{uAbort}(\0\S{}\"sent\0unknown\0message\0to\0\%p\"\SE{},\0\V{msg}.\V{sender}\0);}}
...
Finally, there are three routines that control the actor system.
The following routines control the actor executor by adjusting its thread pool.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{extern}\0\K{unsigned}\0\K{int}\0\V{uDefaultActorThreads}();}\Tab{56}{\C{}\1\1\0user\0threads\0servicing\0executor\0thread\-pool}}
\CE{}\L{\LB{\K{extern}\0\K{unsigned}\0\K{int}\0\V{uDefaultActorProcessors}();}\Tab{56}{\C{}\1\1\0kernel\0threads\0servicing\0executor\0thread\-pool}}
\CE{}\endlgrinde\LGend
These routines set the number of threads and processors created by the actor executor (see \VRef{s:Executors}).
Currently, the defaults are 8 threads and 3 processors (assuming an existing processor makes 4) and the actor executor runs in the user cluster.
...
The \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} member creates two actors and passes each actor three messages, two string messages and a stop message.
...
\end{tabular}
\end{tabular}
\caption{Fibonacci Actor: explicit and implicit state}
...
\L{\LB{}\Tab{4}{\V{IntMsg}(\0\K{int}\0\V{val}\0)\0:\0\V{FutureMessage}(\0\V{uActor}::\V{Delete}\0),\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\};}}
\L{\LB{\K{struct}\0\V{StrMsg}\0:\0\K{public}\0\V{uActor}::\V{FutureMessage}\<\0\V{string}\0\>\0\{}}
\L{\LB{}\Tab{4}{\V{string}\0\V{val};}}
\L{\LB{}\Tab{4}{\V{StrMsg}(\0\V{string}\0\V{val}\0)\0:\0\V{FutureMessage}(\0\V{uActor}::\V{Delete}\0),\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\};}}
\L{\LB{\K{struct}\0\V{IntStrMsg}\0:\0\K{public}\0\V{uActor}::\V{FutureMessage}\<\0\K{int}\0\>\0\{}}
\L{\LB{}\Tab{4}{\V{string}\0\V{val};}}
\L{\LB{}\Tab{4}{\V{IntStrMsg}(\0\V{string}\0\V{val}\0)\0:\0\V{FutureMessage}(\0\V{uActor}::\V{Delete}\0),\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\};}}
\L{\LB{}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\0\V{Times};\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0tell\0messages}}
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\0\V{Times};\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0ask\0messages}}
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{}\Tab{4}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\0\V{Times};\0\V{i}\0+=\01\0)\0\{}\Tab{56}{\C{}\1\1\0access\0future\0values}}
...
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMain}}}\endlgrinde\LGend{} then raises a nonlocal exception %E%) at coroutine %(c%).
