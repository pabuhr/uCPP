...
%% Last Modified On : Wed Sep  6 16:46:43 2017
%% Update Count     : 7356
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
the main (starting) routine is called by a \uC task so all \uC task operations are usable in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}}, e.g., \LGinlinetrue\LGbegin\lgrinde\L{\LB{\Proc{uThisTask}\V{uThisTask}()}}\endlgrinde\LGend{} (see~\VRef{s:TaskInheritedMembers}).
...
\CE{}\L{\LB{\0\0\0\0\K{static}\0\K{struct}\0\V{StartMsg}\0:\0\K{public}\0\V{uActor}::\V{Message}\0\{\}\0\V{startMsg};\0\C{}\1\1\0start\0actor}}
\CE{}\L{\LB{\0\0\0\0\K{static}\0\K{struct}\0\V{StopMsg}\0:\0\K{public}\0\V{uActor}::\V{Message}\0\{\}\0\V{stopMsg};\0\C{}\1\1\0terminate\0actor}}
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{extern}\0\K{unsigned}\0\K{int}\0\V{uDefaultActorProcessors}();}\Tab{48}{\C{}\1\1\0kernel\0threads\0(processors)\0servicing\0executor\0thread\-pool}}
...
\CE{}\L{\LB{\K{extern}\0\K{int}\0\V{uDefaultActorOffset}();}\Tab{48}{\C{}\1\1\0affinity\0offset\0(\-1\0=\>\0no\0affinity,\0default)}}
...
Currently, the defaults are 2 processors and 4 threads and the actor executor runs in the user cluster.
...
Then the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} program waits for all actors to end.
...
In the program, after \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} creates the tasks, it waits for a solution to be found by any of the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Worker}}}\endlgrinde\LGend{} tasks.
...
Hence, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} marks them all for cancellation and uses the result.
After the result has been processed, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} deletes the worker tasks, which allows for execution overlap of result processing with the worker tasks detecting, starting, and finishing cancellation.
Alternatively, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} can delete the workers right away, with the consequence that it may have to wait for the worker tasks to finish cancellation before processing the result.
...
\end{quote}
because no \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{try}}}\endlgrinde\LGend{} statement with an appropriate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{catch}}}\endlgrinde\LGend{} clause is in effect for the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} so propagation fails to locate a matching handler.
...
As a result, the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} finds the mutex object has been destroyed.
...
As a result, when the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the acceptor/signalled stack.
Similarly, the following program:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Task}\0\V{T1}\0\{}}
\L{\LB{\0\0\K{public}:}}
...
As a result, when the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the entry queue of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}.
...
When the blocked call from the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} is accepted, the starting-task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} immediately detects the concurrent exception and does not start the call.
As a result, the starting-task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} implicitly resumes an exception of type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMutexFailure}::\V{RendezvousFailure}}}\endlgrinde\LGend{}\index{uSerial@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uSerial}}}\endlgrinde\LGend{}!RendezvousFailure@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{RendezvousFailure}}}\endlgrinde\LGend{}}\index{RendezvousFailure@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{RendezvousFailure}}}\endlgrinde\LGend{}} concurrently at task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} so it knows the call did not occur and can take appropriate corrective action (see \VRef{s:BreakingRendezvous2}).
...
As a result, when the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} attempts to delete task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t1}}}\endlgrinde\LGend{}, it finds task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t2}}}\endlgrinde\LGend{} still blocked on the condition queue.
...
\end{quote}
because the declaration of the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} by the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} fails due to the request for a 1000000000-byte stack\index{stack!overflow} for \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}.
\end{comment}
...
\CE{}\L{\LB{}\Tab{8}{\V{w}.\V{wait}();}\Tab{28}{\C{}\1\1\0T\0continues\0but\0blocks,\0which\0restarts\0starting\-task\0main}}
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\};}}
\L{\LB{\K{int}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{T}\0\V{t};}}
...
The error message shows that the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} waited first so it became the condition owner, and then \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}'s attempt to wait fails. 
...
\end{quote}
because task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} is first to wait on condition variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{w}}}\endlgrinde\LGend{} due to the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{yield}}}\endlgrinde\LGend{} in the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} routine, and then the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} does not lock mutex-object \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} when calling \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{mem}}}\endlgrinde\LGend{} as it is nomutex.
Only if the starting-task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{} has \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} locked can it access any condition variable owned by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{}.
...
\end{quote}
because the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} happens to delete the user cluster (see \VRef{s:Cluster}) after the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} terminates and before the dynamically allocated task \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{t}}}\endlgrinde\LGend{} has terminated.
...
\end{quote}
because the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uBootTask}}}\endlgrinde\LGend{} deletes the user cluster (see \VRef{s:Cluster}) after the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} terminates but the dynamically allocated processor \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{p}}}\endlgrinde\LGend{} is still on the user cluster.
...
The \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} is a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uPthreadable}}}\endlgrinde\LGend{} task.
...
When the starting \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} routine ends, pthreads semantics cause immediate termination of the program and any outstanding threads, whereas \uC semantics require that all threads be programmatically terminated.
This inconsistency is resolved dynamically in favour of pthreads if any pthreads threads are running when the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} ends.
...
Routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uMainStackSize}}}\endlgrinde\LGend{} is used directly to provide a stack size for the \Index{starting-task} \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}\index{main@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{main}}}\endlgrinde\LGend{}} (see \VRef{s:CompileTimeStructureuCProgram}).
...
\end{list}
\uC requires at least GNU~\cite{GNU-C++}\index{GNU C++@GNU \CC} g++-4.8.0 or greater.
