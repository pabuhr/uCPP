...
%% Last Modified On : Fri Aug 16 10:52:45 2019
%% Update Count     : 7501
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{\0\0\0\0\V{uExecutor}();\0\C{}\1\1\0special\0for\0current\0cluster}}
\CE{}\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nprocessors},}}
\L{\LB{}\Tab{8}{\0\K{bool}\0\V{sepClus}\0=\0\V{uDefaultActorSepClus}(),\0\K{int}\0\V{affAffinity}\0=\0\V{uDefaultActorAffinity}()\0);}}
\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{unsigned}\0\K{int}\0\V{nworkers},}}
\L{\LB{}\Tab{8}{\0\K{bool}\0\V{sepClus}\0=\0\V{uDefaultActorSepClus}(),\0\K{int}\0\V{affAffinity}\0=\0\V{uDefaultActorAffinity}()\0);}}
\L{\LB{\0\0\0\0\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{unsigned}\0\K{int}\0\V{nmailboxes},}}
\L{\LB{}\Tab{8}{\K{bool}\0\V{sepClus}\0=\0\V{uDefaultActorSepClus}(),\0\K{int}\0\V{affAffinity}\0=\0\V{uDefaultActorAffinity}()\0);}}
...
-- creates an executor containing 0 processors, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uThisCluster}().\V{getProcessors}()}}\endlgrinde\LGend{} worker threads and queues, which are created on the current cluster with the cluster's default stack\index{stack!default size} size.
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{bool}\0\V{sepClus},\0\K{int}\0\V{affAffinity})}}\endlgrinde\LGend{}]
-- creates an executor containing \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nprocessors}}}\endlgrinde\LGend{} processors (with default affinity), and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nworkers}}}\endlgrinde\LGend{} worker threads and queues, which are created on the current or separate cluster with the cluster's default stack\index{stack!default size} size.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uExecutor}(\0\K{unsigned}\0\K{int}\0\V{nprocessors},\0\K{unsigned}\0\K{int}\0\V{nworkers},\0\K{unsigned}\0\K{int}\0\V{nmailboxes},\0\K{bool}\0\V{sepClus},}}\endlgrinde\LGend{}]
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{int}\0\V{affAffinity}\0)}}\endlgrinde\LGend{}
-- creates an executor containing \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nprocessors}}}\endlgrinde\LGend{} processors (with default affinity), \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nworkers}}}\endlgrinde\LGend{} worker threads and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{nmailboxes}}}\endlgrinde\LGend{} queues, which are created on the current or separate cluster with the cluster's default stack\index{stack!default size} size.
\end{sloppypar}
\end{prefix}
...
Note, when using the default constructor the processors on the current cluster are used.
Therefore, it is necessary to explicitly populate the current cluster with the appropriate number of processors, e.g., \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uProcessors}\0\V{p}[3]}}\endlgrinde\LGend{} to get 4 processors, as each cluster usually gets an initial processor.
...
\CE{}\L{\LB{\K{extern}\0\K{int}\0\V{uDefaultActorAffinity}();}\Tab{48}{\C{}\1\1\0affinity\0and\0offset\0(\-1\0=\>\0no\0affinity,\0default)}}
...
\index{uDefaultActorAffinity@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uDefaultActorAffinity}}}\endlgrinde\LGend{}}%
...
Routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uDefaultActorAffinity}}}\endlgrinde\LGend{} returns the CPU offset from CPU 0 and forces affinity (-1 $\Rightarrow$ no affinity, default)
...
\L{\LB{\};}}
\L{\LB{\K{int}\0\V{main}()\0\{}}
\L{\LB{\0\0\0\0\V{uActorStart}();}\Tab{56}{\C{}\1\1\0start\0actor\0system}}
...
\L{\LB{\0\0\0\0\V{uActorStop}();}\Tab{56}{\C{}\1\1\0wait\0for\0all\0actors\0to\0terminate}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
\caption{Hello Actor}
\label{f:HelloActor}
...
\CE{}\L{\LB{\0\0\0\0\V{uActorStop}();}\Tab{56}{\C{}\1\1\0wait\0for\0all\0actors\0to\0terminate}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
...
\L{\LB{\V{gettimeofday}(\0\&\V{t1},\0\K{nullptr}\0);}\Tab{32}{\C{}\1\1\0current\0time\0(seconds\0\1\0microseconds)}}
...
Copy \LGinlinetrue\LGbegin\lgrinde\L{\LB{\<\V{prefix}\>\1.\V{gdbinit}}}\endlgrinde\LGend{} to your home directory or merge it into your existing \LGinlinetrue\LGbegin\lgrinde\L{\LB{.\V{gdbinit}}}\endlgrinde\LGend{} file.
