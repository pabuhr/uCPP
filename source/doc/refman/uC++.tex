...
%% Last Modified On : Mon Oct 19 15:42:41 2020
%% Update Count     : 8139
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Each step a message takes between actors is called a \newterm{hop}, and hop links point in ther reverse direction to the message sends.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{erase}}}\endlgrinde\LGend{} deletes all message hops except cursor hop.
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Return}}}\endlgrinde\LGend{} move cursor back (towards tail) one hop and send message to cursor actor.
Return \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{false}}}\endlgrinde\LGend{} if cursor is tail and no action occurs, otherwise \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{true}}}\endlgrinde\LGend{}.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{retSender}}}\endlgrinde\LGend{} move cursor to tail and send message to cursor actor.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{returned}}}\endlgrinde\LGend{} return \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{true}}}\endlgrinde\LGend{} if cursor not at head, otherwise \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{false}}}\endlgrinde\LGend{}.
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{resume}}}\endlgrinde\LGend{} move cursor to head and send message to cursor actor.
...
\L{\LB{}\Tab{4}{\K{template}\<\0\K{typename}\0\V{Result}\0\>\0\K{struct}\0\V{PromiseMsg}\0:\0\K{public}\0\V{Message}\0\{\0.\,.\,.\0\}}}
\L{\LB{\0\0\K{protected}:}}
...
\CE{}\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\K{static}\0\K{inline}\0\V{uActor}\0\*\0\V{sender}();}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{Message}\0\&\0\V{msg},\0\V{uActor}\0\*\0\V{sender}\0);}\Tab{56}{\C{}\1\1\0async\0call,\0no\0return}}
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{Message}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{TraceMsg}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\K{operator}\0\|\0(\0\V{Message}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\K{operator}\0\|\0(\0\V{TraceMsg}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{forward}(\0\V{Message}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{forward}(\0\V{TraceMsg}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\K{template}\<\0\K{typename}\0\V{Result}\0\>\0\V{Promise}\<\0\V{Result}\0\>\0\V{ask}(\0\V{PromiseMsg}\<\0\V{Result}\0\>\0\&\0\V{msg},}}
\L{\LB{}\Tab{12}{\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0)\0\{}\Tab{56}{\C{}\1\1\0async\0call,\0return\0promise}}
\CE{}\L{\LB{}\Tab{4}{\K{template}\<\0\K{typename}\0\V{Result}\0\>\0\V{Promise}\<\0\V{Result}\0\>\0\K{operator}\0\|\,\|\0(\0\V{PromiseMsg}\<\0\V{Result}\0\>\0\&\V{msg}\0);}}
\L{\LB{}\Tab{4}{\C{}\1\1\0Administration}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{restart}();}\Tab{56}{\C{}\1\1\0reset\0actor\0to\0initial\0state}}
\CE{}\L{\LB{}\Tab{4}{\K{static}\0\K{void}\0\V{start}(\0\V{uExecutor}\0\&\0\V{executor}\0)\0\{}\Tab{56}{\C{}\1\1\0wait\0for\0all\0actors\0to\0terminate\0or\0timeout}}
...
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
\index{uActor@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uActor}}}\endlgrinde\LGend{}!receive@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{become}}}\endlgrinde\LGend{}}%
...
\CE{}\L{\LB{\V{promise}\0=\0\V{actor}\-\>\V{ask}(\0\V{msg},\0\K{this}\0);}\Tab{36}{\C{}\1\1\0send\0message\0to\0actor,\0identify\0sender}}
\CE{}\endlgrinde\LGend
...
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{preStart}}}\endlgrinde\LGend{}\index{preStart@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{preStart}}}\endlgrinde\LGend{}} is run after an actor's constructor by an executor thread versus the creating thread executing the actor's constructor.
...
Finally, the Actor system must be started once, which creates the actor thread-pool (executor), and control must wait for all actors to complete.
...
\endlgrinde\LGend
which creates an actor executor containing 0 processors, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\Proc{uThisCluster}\V{uThisCluster}().\V{getProcessors}()}}\endlgrinde\LGend{} worker threads and queues on the current cluster without affinity.
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\Proc{osacquire}\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"data:\"\SE{}\0\<\<\0\V{Monitor}.\V{rtn}(.\,.\,.)\0\<\<\0\V{endl};}}
\endlgrinde\LGend
...
\L{\LB{\Proc{osacquire}\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"data:\"\SE{}\0\<\<\0\V{data}\0\<\<\0\V{endl};}}
\endlgrinde\LGend
...
\L{\LB{}\Tab{4}{\K{void}\0\V{addHead}(\0\V{T}\0\*\0\V{n}\0);}}
\L{\LB{}\Tab{4}{\K{void}\0\V{add}(\0\V{T}\0\*\0\V{n}\0);}}
\L{\LB{}\Tab{4}{\K{void}\0\V{push}(\0\V{T}\0\*\0\V{n}\0);}}
...
\L{\LB{}\Tab{4}{\K{void}\0\V{addHead}(\0\V{T}\0\*\0\V{n}\0);}}
\L{\LB{}\Tab{4}{\K{void}\0\V{addTail}(\0\V{T}\0\*\0\V{n}\0);}}
\L{\LB{}\Tab{4}{\K{void}\0\V{add}(\0\V{T}\0\*\0\V{n}\0);}}
\L{\LB{}\Tab{4}{\V{T}\0\*\0\V{dropHead}();}}
\L{\LB{}\Tab{4}{\V{T}\0\*\0\V{drop}();}}
\L{\LB{}\Tab{4}{\V{T}\0\*\0\V{dropTail}();}}
\L{\LB{}\Tab{4}{\K{void}\0\V{remove}(\0\V{T}\0\*\0\V{n}\0);}}
...
\L{\LB{}\Tab{4}{\K{void}\0\V{insertBef}(\0\V{T}\0\*\0\V{n},\0\V{T}\0\*\0\V{bef}\0);}}
\L{\LB{}\Tab{4}{\K{void}\0\V{insertAft}(\0\V{T}\0\*\0\V{aft},\0\V{T}\0\*\0\V{n}\0);}}
