...
%% Last Modified On : Mon Jan  6 09:17:31 2020
%% Update Count     : 7549
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\L{\LB{\0\0\K{protected}:}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{8}{\K{for}\0(\0;;\0)\0\{\0\V{suspend}();\0\}}}
\L{\LB{}\Tab{4}{\}}}
...
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{exception}(\0\V{uBaseEvent}\0\*\V{ex}\0);}\Tab{44}{\C{}\1\1\0make\0exception\0available\0in\0the\0future}}
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
...
\CE{}\L{\LB{\K{extern}\0\K{unsigned}\0\K{int}\0\V{uDefaultExecutorThreads}();}\Tab{52}{\C{}\1\1\0worker\0threads\0servicing\0work\0requests}}
...
\index{uDefaultExecutorThreads@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uDefaultExecutorThreads}}}\endlgrinde\LGend{}}%
...
Routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uDefaultExecutorThreads}}}\endlgrinde\LGend{} returns the number of threads on the actor executor.
...
Routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uDefaultExecutorSepClus}}}\endlgrinde\LGend{} returns true if the actor executor runs on its own separate cluster, and false if the actor executor runs on the current cluster.
...
Currently, the defaults are 2 processors, 2 threads 2 request queues, and the actor executor runs in the user cluster without affinity.
...
\VRef[Figure]{f:ActorModel} shows the Actor model has an \newterm{actor} (work) front-ended by a \newterm{mailbox} (message queue/bounded buffer) containing messages sent by other actors.
A mailbox contains heterogeneous typed messages.
Actors do not have a thread;
instead they are executed by an underlying thread-pool (executor, see \VRef{s:Executors}), which calls an actor's \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{} member with each message from its mailbox.
...
Actors also create other actors and communicate with these new actors by sending messages to their mailbox.
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\K{enum}\0\V{Allocation}\0\{\0\V{Nodelete},\0\V{Delete},\0\V{Destroy},\0\V{Finished}\0\};\0\C{}\1\1\0allocation\0actions}}
\CE{}\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\};}}
\endlgrinde\LGend
...
\begin{prefix}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Nodelete}}}\endlgrinde\LGend{}] means either the actor or message persists after an actor returns from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{}.
Use for multi-use actors or messages during their life time. (message default)
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Delete}}}\endlgrinde\LGend{}] means either the actor or message is deleted after an actor returns from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{}.
Use with dynamically allocated actors or messages at completion.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Destroy}}}\endlgrinde\LGend{}] means either the actor's or message's destructor is called after an actor returns from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{} but storage is not deallocated.
Use with placement allocated actors or messages at completion.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Finished}}}\endlgrinde\LGend{}] means the actor is marked finished after it returns from \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{} but neither the destructor is called nor storage deallocated.
(No action for a message.)
...
\L{\LB{}\Tab{4}{\V{uActor}\0\*\0\V{sender};}\Tab{56}{\C{}\1\1\0delegated\0sender}}
\CE{}\L{\LB{}\Tab{4}{\V{Allocation}\0\V{allocation};}\Tab{56}{\C{}\1\1\0allocation\0status}}
\CE{}\L{\LB{}\Tab{4}{\V{Message}(\0\V{Allocation}\0\V{allocation}\0=\0\V{Nodelete},\0\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0);}}
...
\CE{}\L{\LB{}\Tab{4}{\V{ReplyMsg}(\0\V{Allocation}\0\V{allocation}\0=\0\V{Nodelete},\0\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0);}}
...
\L{\LB{}\Tab{4}{\K{virtual}\0\K{void}\0\V{delivery}(\0\V{uBaseEvent}\0\*\0\V{ex}\0)\0=\00;}}
...
\CE{}\L{\LB{}\Tab{4}{\V{FutureMessage}(\0\V{Allocation}\0\V{allocation}\0=\0\V{Nodelete},\0\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0);}}
...
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{delivery}(\0\V{Result}\0\V{res}\0);}\Tab{56}{\C{}\1\1\0raises\0uDelivered}}
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
...
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{Message}\0\&\0\V{msg},\0\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0);\0\C{}\1\1\0async\0call,\0no\0return}}
...
\L{\LB{}\Tab{12}{\V{uActor}\0\*\0\V{sender}\0=\0\K{nullptr}\0)\0\{}\Tab{56}{\C{}\1\1\0async\0call,\0return\0future}}
...
\CE{}\L{\LB{}\Tab{8}{\V{msg\_d}\-\>\BF{\V{delivery}}(\0\V{val}\0);}\Tab{56}{\C{}\1\1\0deliver\0value\0into\0future}}
\CE{}\L{\LB{}\Tab{4}{\}\0.\,.\,.}}
\endlgrinde\LGend
All future operations are available through the variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{msg\_d}}}\endlgrinde\LGend{}.
...
\CE{}\L{\LB{}\Tab{8}{\V{msg\_d}\-\>\V{delivery}(\0\BF{\K{new}\0\V{MyEvent}(\0.\,.\,.\0)}\0);}\Tab{56}{\C{}\1\1\0future\0complain}}
\CE{}\L{\LB{}\Tab{8}{\C{}\1\1\0\_Throw\0uActor::Unhandled(\0msg\_d\0);}\Tab{56}{\1\1\0alternative}}
...
the other approach is to raise an exception, which is caught by the the thread executing the actor and this thread implicitly duplicates the exception into the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{FutureMessage}}}\endlgrinde\LGend{}.
...
\CE{}\L{\LB{}\Tab{12}{\K{if}\0(\0\V{str\_d}\-\>\V{val}\0==\0\S{}\"hello\"\SE{}\0)\0\{}}
...
\L{\LB{}\Tab{12}{\}}}
\L{\LB{}\Tab{8}{\}\0\K{else}\0\V{Case}(\0\V{StopMsg},\0\V{str}\0)\0\{}}
...
\L{\LB{\};}}
\L{\LB{\K{int}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{uActorStart}();}\Tab{56}{\C{}\1\1\0start\0actor\0system}}
...
\L{\LB{}\Tab{4}{\V{uActorStop}();}\Tab{56}{\C{}\1\1\0wait\0for\0all\0actors\0to\0terminate}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
\caption{Hello Actor}
\label{f:HelloActor}
...
Finally, the Actor system must be started, which creates the actor thread-pool (executor), and control must wait for all actors to complete.
Macro \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uActorStart}}}\endlgrinde\LGend{} is the default way to start an actor system:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\#define}\0\V{uActorStart}()\0\V{uExecutor}\0\V{\_\_uExecutor\_\_}(\00,\0\V{uThisCluster}().\V{getProcessors}(),\0\K{false},\0\-1\0);\0\2}}
\L{\LB{}\Tab{20}{\V{uActor}::\V{start}(\0\V{\_\_uExecutor\_\_}\0)}}
\endlgrinde\LGend
which creates an actor executor containing 0 processors, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uThisCluster}().\V{getProcessors}()}}\endlgrinde\LGend{} worker threads and queues on the current cluster without affinity.
Macro \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uActorStop}}}\endlgrinde\LGend{} is the default way to wait for the actor system to end:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\#define}\0\V{uActorStop}()\0\V{uActor}::\V{stop}()}}
\endlgrinde\LGend
...
Once in a discrimination clause, the variable \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{msg\_d}}}\endlgrinde\LGend{} is used to access the string in the message.
...
\CE{}\L{\LB{}\Tab{12}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"Actor\0\"\SE{}\0\<\<\0\V{msg\_d}\-\>\V{val}\0\<\<\0\V{endl};}}
\L{\LB{}\Tab{12}{\V{msg\_d}\-\>\V{delivery}(\07\0);}\Tab{56}{\C{}\1\1\0insert\0value\0into\0future}}
\CE{}\L{\LB{}\Tab{8}{\}\0\K{else}\0\V{Case}(\0\V{StrMsg},\0\V{msg}\0)\0\{}}
\L{\LB{}\Tab{12}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"Actor\0\"\SE{}\0\<\<\0\V{msg\_d}\-\>\V{val}\0\<\<\0\V{endl};}}
\L{\LB{}\Tab{12}{\V{msg\_d}\-\>\V{delivery}(\0\S{}\"XYZ\"\SE{}\0);}\Tab{56}{\C{}\1\1\0insert\0value\0into\0future}}
\CE{}\L{\LB{}\Tab{8}{\}\0\K{else}\0\V{Case}(\0\V{IntStrMsg},\0\V{msg}\0)\0\{}}
\L{\LB{}\Tab{12}{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"Actor\0\"\SE{}\0\<\<\0\V{msg\_d}\-\>\V{val}\0\<\<\0\V{endl};}}
\L{\LB{}\Tab{12}{\V{msg\_d}\-\>\V{delivery}(\012\0);}\Tab{56}{\C{}\1\1\0insert\0value\0into\0future}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\V{uActorStart}();}\Tab{56}{\C{}\1\1\0start\0actor\0system}}
\CE{}\L{\LB{}\Tab{4}{\V{Actor}\0\*\0\V{actor}\0=\0\K{new}\0\V{Actor};}}
\L{\LB{}}
...
\CE{}\L{\LB{}\Tab{4}{\V{uActorStop}();}\Tab{56}{\C{}\1\1\0wait\0for\0all\0actors\0to\0terminate}}
\CE{}\L{\LB{\}}}
\endlgrinde\LGend
...
\L{\LB{}\Tab{8}{\~\V{FileAccess}();}}
\L{\LB{}\Tab{4}{}}
\L{\LB{}\Tab{8}{\K{int}\0\V{read}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{8}{\K{int}\0\V{readv}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{8}{\K{\_Mutex}\0\K{int}\0\V{write}(\0\K{const}\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{8}{\K{int}\0\V{writev}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{int}\0\V{read}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{readv}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{\_Mutex}\0\K{int}\0\V{write}(\0\K{const}\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{writev}(\0\K{const}\0\K{struct}\0\V{iovec}\0\*\V{iov},\0\K{int}\0\V{iovcnt},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{send}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendto}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendto}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{struct}\0\V{sockaddr}\0\*\V{to},\0\V{socklen\_t}\0\V{tolen},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{sendmsg}(\0\K{const}\0\K{struct}\0\V{msghdr}\0\*\V{msg},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recv}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recvfrom}(\0\K{char}\0\*\V{buf},\0\K{int}\0\V{len},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
...
\L{\LB{}\Tab{20}{\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{recvmsg}(\0\K{struct}\0\V{msghdr}\0\*\V{msg},\0\K{int}\0\V{flags}\0=\00,\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\V{ssize\_t}\0\V{sendfile}(\0\V{FileAccess}\0\&\V{file},\0\V{off\_t}\0\*\V{off},\0\V{size\_t}\0\V{len},\0\V{uDuration}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
...
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\K{nullptr},\0\V{socklen\_t}\0\*\V{len}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\V{uDuration}\0\*\V{timeout},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\K{nullptr},\0\V{socklen\_t}\0\*\V{len}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\K{bool}\0\V{doAccept},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\K{nullptr},\0\V{socklen\_t}\0\*\V{len}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\V{uSocketAccept}(\0\V{uSocketServer}\0\&\V{s},\0\V{uDuration}\0\*\V{timeout},\0\K{bool}\0\V{doAccept},\0\K{struct}\0\V{sockaddr}\0\*\V{adr}\0=\0\K{nullptr},}}
\L{\LB{}\Tab{20}{\V{socklen\_t}\0\*\V{len}\0=\0\K{nullptr}\0);}}
...
if the exception has been raised locally, the value \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{nullptr}}}\endlgrinde\LGend{} is returned.
...
\item when an \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{\_Enable}}}\endlgrinde\LGend{} statement begins,
...
Error occurred while executing task main (0x7fffec02ac70).
\end{quote}
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{int}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\K{int}\0\*\V{ip}\0=\0\K{nullptr};}\Tab{32}{\C{}\1\1\0set\0address\0to\00}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{int}\0\V{select}(\0\K{int}\0\V{fd},\0\K{int}\0\V{rwe},\0\V{timeval}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}\Tab{4}{\K{int}\0\V{select}(\0\K{int}\0\V{nfds},\0\V{fd\_set}\0\*\V{rfd},\0\V{fd\_set}\0\*\V{wfd},\0\V{fd\_set}\0\*\V{efd},\0\V{timeval}\0\*\V{timeout}\0=\0\K{nullptr}\0);}}
\L{\LB{}}
...
\begin{prefix}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{select}(\0\K{int}\0\V{fd},\0\K{int}\0\V{rwe},\0\V{timeval}\0\*\V{timeout}\0=\0\K{nullptr}\0)}}\endlgrinde\LGend{}]
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{select}(\0\K{int}\0\V{nfds},\0\V{fd\_set}\0\*\V{rfd},\0\V{fd\_set}\0\*\V{wfd},\0\V{fd\_set}\0\*\V{efd},\0\V{timeval}\0\*\V{timeout}\0=\0\K{nullptr}\0)}}\endlgrinde\LGend{}]
...
For debuggers that handle multiple kernel threads (corresponding to \uC virtual processors), it is possible to examine the active task running on each kernel thread (also see\VRef{c:GDBCheatSheet}).
% switching to none
\LGinlinefalse\LGbegin\lgrinde
...
\item
linux-x86\_32 : Linux 2.4.x or greater, AMD/Intel 32-bit
\item
linux-x86\_64 : Linux 2.4.x or greater, AMD/Intel 64-bit
% \item
...
\begin{description}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{malloc}(\0\V{size}\0)}}\endlgrinde\LGend{}] allocate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the allocated memory;
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{realloc}(\0\V{ptr},\0\V{size}\0)}}\endlgrinde\LGend{}] change the size of the memory referenced by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{ptr}}}\endlgrinde\LGend{} to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the allocated memory;
if the size change requires new storage (smaller or larger), as much data as possible it copied from the old storage and the old storage is freed.
Any uncopied memory in the new storage is uninitialized.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{posix\_memalign}(\0\V{alignment},\0\V{size}\0)}}\endlgrinde\LGend{}] allocate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the allocated memory;
...
\begin{description}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{memalign}(\0\V{alignment},\0\V{size}\0)}}\endlgrinde\LGend{}] allocate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the allocated memory;
the address returned is a multiple of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{alignment}}}\endlgrinde\LGend{} and memory is uninitialized.
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{realloc}(\0\V{ptr},\0\V{alignment},\0\V{size}\0)}}\endlgrinde\LGend{}] change the alignment and size of the memory referenced by \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{ptr}}}\endlgrinde\LGend{} to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{alignment}}}\endlgrinde\LGend{} boundary and \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the aligned allocated memory;
if the size change requires new storage (smaller or larger), as much data as possible it copied from the old storage and the old storage is freed.
Any uncopied memory in the new storage is uninitialized.
...
\begin{description}
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{cmemalign}(\0\V{alignment},\0\V{size}\0)}}\endlgrinde\LGend{}] allocate \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{size}}}\endlgrinde\LGend{} bytes and return a pointer to the allocated memory;
the address returned is a multiple of \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{alignment}}}\endlgrinde\LGend{} and memory is zero filled.
\end{description}
...
\item[\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{realloc}(\0\V{ptr},\0\V{alignment},\0\V{size}\0)}}\endlgrinde\LGend{}] same semantics as before with the addition of new alignment and the zero fill property is preserved if a new allocation is made.
...
If \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{ptr}}}\endlgrinde\LGend{} is \LGinlinetrue\LGbegin\lgrinde\L{\LB{\K{nullptr}}}\endlgrinde\LGend{}, the minimal alignment for any allocation is returned, e.g., multiple of 8.
...
\chapter{GDB Cheatsheet for $\mu$C++}
\label{c:GDBCheatSheet}
...
\begin{flushleft}
\begin{tabular}{@{}p{0.25\textwidth} p{0.5\textwidth} p{0.2\textwidth}@{}}
\textbf{\emph{Command}}			& \textbf{\emph{Description}}	& \textbf{\emph{Example}}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{clusters}}}\endlgrinde\LGend{}					& print a list of all clusters	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{clusters}}}\endlgrinde\LGend{}				\\
\end{tabular}
\end{flushleft}
...
\begin{tabular}{@{}p{0.25\textwidth} p{0.5\textwidth} p{0.2\textwidth}@{}}
\textbf{\emph{Command}}			& \textbf{\emph{Description}}	& \textbf{\emph{Example}}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{processors}}}\endlgrinde\LGend{}						& print all info about all processors on all clusters	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{processors}}}\endlgrinde\LGend{}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{processors}}}\endlgrinde\LGend{} \textit{clusterName}	& print all info about all processors on a particular cluster	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{processors}\0\V{userCluster}}}\endlgrinde\LGend{}	\\
\end{tabular}
\end{flushleft}
...
\begin{tabular}{@{}p{0.25\textwidth} p{0.5\textwidth} p{0.2\textwidth}@{}}
\textbf{\emph{Command}}			& \textbf{\emph{Description}}					& \textbf{\emph{Example}}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{}						& print application tasks in \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{userCluster}}}\endlgrinde\LGend{}	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{}					\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{} \textit{clusterName}	& print application tasks in a clusterName		& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\0\V{clusterA}}}\endlgrinde\LGend{}			\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\0\V{all}}}\endlgrinde\LGend{}					& print all tasks in all clusters				& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\0\V{all}}}\endlgrinde\LGend{}				\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{} \textit{id}			& context switch to task \textit{id} on \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{userCluster}}}\endlgrinde\LGend{}	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\02}}\endlgrinde\LGend{}		\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{} \LGinlinetrue\LGbegin\lgrinde\L{\LB{0x}}\endlgrinde\LGend{}\textit{address}	& context switch to a task based on its address on any cluster	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\00x80024875}}\endlgrinde\LGend{}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}}}\endlgrinde\LGend{} \textit{id} \textit{clusterName}	& context switch to a task on a specified cluster	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{task}\02\0\V{clusterA}}}\endlgrinde\LGend{}	\\
\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{prevtask}}}\endlgrinde\LGend{}					& switch back to the previous task on the stack	& \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{prevtask}}}\endlgrinde\LGend{}				\\
\end{tabular}
\end{flushleft}
