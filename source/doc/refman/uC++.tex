...
%% Last Modified On : Mon Dec 27 14:44:40 2021
%% Update Count     : 8313
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\VRef[Figure]{f:ActorModel} shows the actor model has an \newterm{actor} composed of multiple \newterm{behaviours} (work) front-ended by a \newterm{mailbox} (message queue/bounded buffer) containing messages
...
Use with \Index{placement allocate}d actors or messages, where the storage is subsequently deallocated.
...
All actor messages must inherit from base-type \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uActor}::\V{Message}}}\endlgrinde\LGend{}:
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{class}\0\V{Message}\0\{}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{Allocation}\0\V{allocation};}\Tab{56}{\C{}\1\1\0allocation\0action}}
...
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\*\0\V{sender}();}\Tab{56}{\C{}\1\1\0sender\0actor}}
\CE{}\L{\LB{\};}\Tab{4}{}}
\endlgrinde\LGend
...
\begin{figure}
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{class}\0\V{TraceMsg}\0:\0\K{public}\0\V{Message}\0\{}}
\L{\LB{\0\0\K{public}:}}
...
\caption{Trace Message}
\label{f:TraceMessage}
\end{figure}

\begin{figure}
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{template}\<\0\K{typename}\0\V{Result}\0\>\0\K{class}\0\V{PromiseMsg}\0:\0\K{public}\0\V{Message}\0\{}}
...
In general, a client actor creates a \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{PromiseMsg}}}\endlgrinde\LGend{} containing an empty \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{Promise}}}\endlgrinde\LGend{} and sends this message to a server actor.
...
The server actor does some work asynchronously, based on the values in the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{PromiseMsg}}}\endlgrinde\LGend{}, and delivers the result into the \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{PromiseMsg}}}\endlgrinde\LGend{}'s promise.
...
The server calls member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{delivery}}}\endlgrinde\LGend{}, which races \emph{after} it delivers (fulfills) the promise result and then
...
\end{itemize}
The client calls member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{maybe}}}\endlgrinde\LGend{} or \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{then}}}\endlgrinde\LGend{}, which runs the race in one of two ways:
...
is the same as \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{maybe}}}\endlgrinde\LGend{}, but if the client loses the race, it implicitly calls the callback.
\end{description}
...
\begin{figure}
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{template}\<\K{typename}\0\V{T}\>\0\K{class}\0\V{Promise}\0\{}}
\L{\LB{}\Tab{4}{\V{std}::\V{function}\<\0\K{void}\0(\0\V{T}\0\&\0)\0\>\0\V{callback};}}
\L{\LB{\0\0\K{public}:}}
...
\L{\LB{}\Tab{4}{\V{Promise}(\0\K{const}\0\V{Promise}\<\V{T}\>\0\&\0\V{rhs}\0);}}
\L{\LB{}\Tab{4}{\V{Promise}\<\V{T}\>\0\&\0\K{operator}=(\0\K{const}\0\V{Promise}\<\V{T}\>\0\&\0\V{rhs}\0);}}
\L{\LB{}}
\L{\LB{}\Tab{4}{\C{}\1\1\0USED\0BY\0CLIENT}}
\CE{}\L{\LB{}\Tab{4}{\K{bool}\0\V{maybe}(\0\V{std}::\V{function}\<\K{void}\0(\0\V{T}\0)\>\0\V{callback}\0);}\Tab{56}{\C{}\1\1\0access\0result}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{then}(\0\V{std}::\V{function}\<\K{void}\0(\0\V{T}\0)\>\0\V{callback}\0);}\Tab{56}{\C{}\1\1\0access\0result}}
\CE{}\L{\LB{}\Tab{4}{\V{T}\0\V{result}();}}
\L{\LB{}\Tab{4}{\V{T}\0\K{operator}()()}\Tab{56}{\C{}\1\1\0alternate\0syntax\0for\0result}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{reset}();}\Tab{56}{\C{}\1\1\0mark\0promise\0as\0empty\0(for\0reuse)}}
\CE{}\L{\LB{}}
\L{\LB{}\Tab{4}{\C{}\1\1\0USED\0BY\0SERVER}}
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{delivery}(\0\V{T}\0\V{result}\0);}\Tab{56}{\C{}\1\1\0make\0result\0available\0in\0the\0promise}}
...
\CE{}\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\C{}\1\1\0Message\0Types}}
\CE{}\L{\LB{}\Tab{4}{\K{class}\0\V{Message}\0\{\0.\,.\,.\0\};}}
\L{\LB{}\Tab{4}{\K{class}\0\V{TraceMsg}\0:\0\K{public}\0\V{Message}\0\{\0.\,.\,.\0\};}}
\L{\LB{}\Tab{4}{\K{template}\<\K{typename}\0\V{T}\>\0\K{class}\0\V{Promise}\0\{\0.\,.\,.\0\};}}
\L{\LB{}\Tab{4}{\K{template}\<\K{typename}\0\V{Result}\>\0\K{struct}\0\V{PromiseMsg}\0:\0\K{public}\0\V{Message}\0\{\0.\,.\,.\0\}}}
\L{\LB{}\Tab{4}{\C{}\1\1\0Storage\0management}}
\CE{}\L{\LB{}\Tab{4}{\K{enum}\0\V{Allocation}\0\{\0\V{Nodelete},\0\V{Delete},\0\V{Destroy},\0\V{Finished}\0\};\0\C{}\1\1\0allocation\0status}}
...
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{Message}\0\&\0\V{msg},\0\V{uActor}\0\*\0\V{sender}\0);}\Tab{56}{\C{}\1\1\0message\0send,\0no\0return}}
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{Message}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{tell}(\0\V{TraceMsg}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\K{operator}\0\|\0(\0\V{Message}\0\&\0\V{msg}\0);}\Tab{56}{\C{}\1\1\0tell\0alternative}}
\CE{}\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\K{operator}\0\|\0(\0\V{TraceMsg}\0\&\0\V{msg}\0);}}
\L{\LB{}\Tab{4}{\V{uActor}\0\&\0\V{forward}(\0\V{Message}\0\&\0\V{msg}\0);}\Tab{56}{\C{}\1\1\0do\0not\0update\0message\0sender}}
...
\CE{}\L{\LB{\V{actor}\-\>\V{tell}(\0\V{msg},\0\BF{\V{proxysender}}\0);}\Tab{48}{\C{}\1\1\0send\0message\0to\0actor\0containing\0proxy\0sender}}
\CE{}\endlgrinde\LGend
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{}\Tab{4}{\V{Case}(\0\V{PMsg},\0\V{msg}\0)\0\{}\Tab{56}{\C{}\1\1\0PMsg\0type\0?}}
...
\L{\LB{}\Tab{4}{.\,.\,.}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{\Proc{MyActor}}\Tab{4}{\V{MyActor}(\0\V{OtherActor}\0\*\0\V{partner}\0)\0:\0\V{partner}(\0\V{partner}\0)\0\{\}\0\C{}\1\1\0executed\0by\0creator\'s\0thread}}
\CE{}\L{\LB{\};}}
\endlgrinde\LGend
...
The member routine \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{restart}}}\endlgrinde\LGend{}\index{restart@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{restart}}}\endlgrinde\LGend{}} resets an actor's receive member to \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{receive}}}\endlgrinde\LGend{} and reruns member \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{preStart}}}\endlgrinde\LGend{} so the actor can be re-purposed for a new use rather than being deleting and creating a new actor.
...
\endlgrinde\LGend
which contains 0 new processors, \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uThisCluster}().\V{getProcessors}()}}\endlgrinde\LGend{} worker threads and queues on the current cluster without affinity.
...
\L{\LB{\Proc{Case}}\Tab{4}{\V{Case}(\0\V{MsgType1},\0\V{msg}\0)\0\{}\Tab{56}{\C{}\1\1\0handle\0known\0message\0types}}
\CE{}\L{\LB{}\Tab{8}{.\,.\,.}}
...
\VRef[Figure]{f:HelloActor} shows a basic actor receiving a number of messages containg strings.
...
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\K{public}:}}
\L{\LB{\Proc{Fib}}\Tab{4}{\V{Fib}()\0\{\0\BF{\V{become}(\0\&\V{Fib}::\V{f0}\0);}\0\}}}
\L{\LB{\};}}
\endlgrinde\LGend
}% subfloat
\vrule
...
\L{\LB{\Proc{IntMsg}}\Tab{4}{\V{IntMsg}()\0\{\}}}
\L{\LB{\Proc{IntMsg}}\Tab{4}{\V{IntMsg}(\0\K{int}\0\V{val}\0)\0:\0\V{PromiseMsg}(\0\V{uActor}::\V{Delete}\0),\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\};}}
\L{\LB{\K{struct}\0\V{StrMsg}\0:\0\K{public}\0\V{uActor}::\V{PromiseMsg}\<\0\V{string}\0\>\0\{}}
\L{\LB{}\Tab{4}{\V{string}\0\V{val};}}
\L{\LB{\Proc{StrMsg}}\Tab{4}{\V{StrMsg}()\0\{\}}}
\L{\LB{\Proc{StrMsg}}\Tab{4}{\V{StrMsg}(\0\V{string}\0\V{val}\0)\0:\0\V{PromiseMsg}(\0\V{uActor}::\V{Delete}\0),\0\V{val}(\0\V{val}\0)\0\{\}}}
\L{\LB{\};}}
...
\L{\LB{}}
\L{\LB{}\Tab{4}{\K{\#define}\0\V{ICB}\0[\K{this},\0\V{li}\0=\0\V{i}](\0\K{int}\0)\0\{\0\*\K{this}\0\|\0\V{intmsg}[\V{li}];\0\}}}
\L{\LB{}\Tab{4}{\K{\#define}\0\V{SCB}\0[\K{this},\0\V{li}\0=\0\V{i}](\0\V{string}\0)\0\{\0\*\K{this}\0\|\0\V{strmsg}[\V{li}];\0\}}}
\L{\LB{}}
...
\CE{}\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{\Proc{Client}}\Tab{4}{\V{Client}(\0\V{Server}\0\&\0\V{server}\0)\0:\0\V{server}(\0\V{server}\0)\0\{\}}}
\L{\LB{\};}}
\L{\LB{\K{int}\0\V{main}()\0\{}}
\L{\LB{}\Tab{4}{\V{uActor}::\V{start}();}\Tab{56}{\C{}\1\1\0start\0actor\0system}}
\CE{}\L{\LB{}\Tab{4}{\V{Server}\0\V{server};}}
\L{\LB{}\Tab{4}{\V{Client}\0\V{client}(\0\V{server}\0);}}
\L{\LB{}\Tab{4}{\V{client}\0\|\0\V{uActor}::\V{startMsg};}\Tab{56}{\C{}\1\1\0terminate\0actor}}
...
\L{\LB{\V{osacquire}(\0\V{cout}\0)\0\<\<\0\S{}\"data:\"\SE{}\0\<\<\0\BF{\V{data}}\0\<\<\0\V{endl};}}
\endlgrinde\LGend
...
While a primary goal of programming is computing values that are \emph{not} random, random values are useful. e.g., simulation, cryptography, games, etc.
...
The least-significant bits \emph{appear} random but the same bits always appear given a fixed starting value, called the \newterm{seed} (value 0x3e8e36 above).
Hence, if a program uses the same seed, the same sequence of random values is generated from the PRNG.
Often, the seed it set to some other random value like the a program's process identifier (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{getpid}}}\endlgrinde\LGend{}\index{getpid@\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{getpid}}}\endlgrinde\LGend{}}) or time when the program is run;
hence, one random value bootstraps another.
Finally, a PRNG usually generates large values in the range of \LGinlinetrue\LGbegin\lgrinde\L{\LB{[0,\0\V{UINT\_MAX}]}}\endlgrinde\LGend{}, and programmers scales these values using the modulus operator, e.g., \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{prng}()\0\%\05}}\endlgrinde\LGend{} produces random values in the range 0--4.

\uC provides a sequential and concurrent PRNG.
\begin{itemize}
\item
For sequential programs, like coroutining, the PRNG can be used to randomize behaviour or values during execution, e.g., in games a character makes a random move or an object takes on a random value.
Sequential execution is repeatable given the same starting seeds for all PRNGs. 
In this scenario, it is useful to have multiple PRNG, e.g., one per player or object so a class is provided to generate multiple instances.
\LGinlinefalse\LGbegin\lgrinde
...
\CE{}\L{\LB{}\Tab{4}{\K{void}\0\V{set\_seed}(\0\V{uint32\_t}\0\V{seed\_}\0);}\Tab{52}{\C{}\1\1\0set\0seed}}
\CE{}\L{\LB{}\Tab{4}{\V{uint32\_t}\0\V{get\_seed}()\0\K{const};}\Tab{52}{\C{}\1\1\0get\0seed}}
\CE{}\L{\LB{}\Tab{4}{\V{uint32\_t}\0\K{operator}()();}\Tab{52}{\C{}\1\1\0[0,UINT\_MAX]}}
\CE{}\L{\LB{}\Tab{4}{\V{uint32\_t}\0\K{operator}()(\0\V{uint32\_t}\0\V{u}\0);}\Tab{52}{\C{}\1\1\0[0,u)}}
\CE{}\L{\LB{}\Tab{4}{\V{uint32\_t}\0\K{operator}()(\0\V{uint32\_t}\0\V{l},\0\V{uint32\_t}\0\V{u}\0);}\Tab{52}{\C{}\1\1\0[l,u]}}
\CE{}\L{\LB{}\Tab{4}{\V{uint32\_t}\0\V{calls}()\0\K{const};}}
\L{\LB{\};}}
\endlgrinde\LGend
The following example creates two sequential PRNGs, sets them both to the same seed (1009), and shows the 3 forms for generating random values, where both PRNGs generate the same sequence of values.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\V{PRNG}\0\V{sprng1},\0\V{sprng2};}}
\L{\LB{\BF{\V{sprng1}.\V{set\_seed}(\01009\0);\0\0\0\V{sprng2}.\V{set\_seed}(\01009\0);}}}
\L{\LB{\K{for}\0(\0\K{unsigned}\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\015;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{4}{\V{cout}\0\<\<\0\BF{\V{sprng1}()}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{sprng1}(\05\0)}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{sprng1}(\00,\05\0)}\0\<\<\0\S{}\'\2t\2t\'\SE{};}}
\L{\LB{}\Tab{4}{\V{cout}\0\<\<\0\BF{\V{sprng2}()}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{sprng2}(\05\0)}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{sprng2}(\00,\05\0)}\0\<\<\0\V{endl};}}
\L{\LB{\}}}
\endlgrinde\LGend
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\0\0\037305757\03\03}\Tab{20}{\0\0\037305757\03\03}}
\L{\LB{1821310498\04\01}\Tab{20}{1821310498\04\01}}
\L{\LB{\0603686050\03\04}\Tab{20}{\0603686050\03\04}}
\L{\LB{1354865902\00\00}\Tab{20}{1354865902\00\00}}
\L{\LB{\0419569906\04\01}\Tab{20}{\0419569906\04\01}}
\L{\LB{\0224287468\00\03}\Tab{20}{\0224287468\00\03}}
\L{\LB{2338967995\02\04}\Tab{20}{2338967995\02\04}}
\L{\LB{\0925028647\03\00}\Tab{20}{\0925028647\03\00}}
\L{\LB{\0553419481\00\01}\Tab{20}{\0553419481\00\01}}
\L{\LB{\0890860879\01\04}\Tab{20}{\0890860879\01\04}}
\L{\LB{1488185164\03\04}\Tab{20}{1488185164\03\04}}
\L{\LB{2393505511\01\03}\Tab{20}{2393505511\01\03}}
\L{\LB{1935722428\02\02}\Tab{20}{1935722428\02\02}}
\L{\LB{1861488646\00\02}\Tab{20}{1861488646\00\02}}
\L{\LB{2246946481\03\04}\Tab{20}{2246946481\03\04}}
\endlgrinde\LGend
\item
For concurrent programs, the PRNG can be used to randomize execution in short-running concurrent programs, e.g., \LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{yield}(\0\V{prng}()\0\%\05\0)}}\endlgrinde\LGend{}.
Beause concurrent execution is non-deterministic, seeding the concurrent PRNG is less important, because repeatable execution is impossible.
It is important for the PRNG to be thread-safe and not a point of contention.
Hence, only one system-wide PRNG is needed, and each kernel thread (\LGinlinetrue\LGbegin\lgrinde\L{\LB{\V{uProcessor}}}\endlgrinde\LGend{}) has its own implicit PRNG used by wherever user threads happen to execute on that processor.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{void}\0\V{set\_seed}(\0\V{uint32\_t}\0\V{seed}\0);}\Tab{52}{\C{}\1\1\0set\0kernel\-thread\0seed}}
\CE{}\L{\LB{\V{uint32\_t}\0\V{get\_seed}();}\Tab{52}{\C{}\1\1\0get\0seed}}
...
\CE{}\endlgrinde\LGend
The following example uses the system-wide PRNG, sets the starting seed (1009) for all kernel threads, and shows the 3 forms for generating random values.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\BF{\V{set\_seed}(\01009\0);}}}
\L{\LB{\K{for}\0(\0\K{unsigned}\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\015;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{4}{\V{cout}\0\<\<\0\BF{\V{prng}()}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{prng}(\05\0)}\0\<\<\0\S{}\'\0\'\SE{}\0\<\<\0\BF{\V{prng}(\00,\05\0)}\0\<\<\0\V{endl};}}
\L{\LB{\}}}
\endlgrinde\LGend
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\0\0\037305757\03\03}}
\L{\LB{1821310498\04\01}}
\L{\LB{\0603686050\03\04}}
\L{\LB{1354865902\00\00}}
\L{\LB{\0419569906\04\01}}
\L{\LB{\0224287468\00\03}}
\L{\LB{2338967995\02\04}}
\L{\LB{\0925028647\03\00}}
\L{\LB{\0553419481\00\01}}
\L{\LB{\0890860879\01\04}}
\L{\LB{1488185164\03\04}}
\L{\LB{2393505511\01\03}}
\L{\LB{1935722428\02\02}}
\L{\LB{1861488646\00\02}}
\L{\LB{2246946481\03\04}}
\endlgrinde\LGend
\end{itemize}

To ensure each \uC task generates the same random number, independent of nondeterministic time-slicing, requires each task to have its own fixed seed and run its own PRNG.
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\K{\_Task}\0\V{T}\0\{}}
\L{\LB{}\Tab{4}{\K{const}\0\K{unsigned}\0\K{int}\0\V{tid};}}
\L{\LB{}\Tab{4}{\K{void}\0\V{main}()\0\{}}
\L{\LB{}\Tab{8}{\V{PRNG}\0\V{prng}(\0\V{tid}\0\*\01009\0);}\Tab{52}{\C{}\1\1\0repeatable\0seed}}
\CE{}\L{\LB{}\Tab{8}{\K{for}\0(\0\K{int}\0\V{i}\0=\00;\0\V{i}\0\<\05;\0\V{i}\0+=\01\0)\0\{}}
\L{\LB{}\Tab{12}{\V{yield}(\0\V{prng}(\010\0)\0);}\Tab{52}{\C{}\1\1\0random\0integer\0between\00\-9}}
\CE{}\L{\LB{}\Tab{12}{.\,.\,.}}
\L{\LB{}\Tab{8}{\}}}
\L{\LB{}\Tab{4}{\}}}
\L{\LB{\0\0\K{public}:}}
\L{\LB{}\Tab{4}{\V{T}(\0\K{unsigned}\0\K{int}\0\V{tid}\0)\0:\0\V{tid}(\0\V{tid}\0)\0\{\}}}
\L{\LB{\};}}
\endlgrinde\LGend
