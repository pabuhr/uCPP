...
%% Last Modified On : Sat Jul 12 09:27:56 2014
%% Update Count     : 6730
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace{0.125in}
\href{http://plg.uwaterloo.ca/~usystem/pub/uSystem/u++-6.0.0.sh}{\uC download} or \href{https://github.com/pabuhr/uCPP}{Github} (installation: \textsf{sudo sh u++-6.0.0.sh}) \\
} % title
\author{
...
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{(\V{gdb})\0\V{handle}\0\V{SIGALRM}\0\V{nostop}\0\V{noprint}\0\V{pass}\0\V{ignore}}}
\L{\LB{(\V{gdb})\0\V{handle}\0\V{SIGUSR1}\0\V{nostop}\0\V{noprint}\0\V{pass}\0\V{ignore}}}
\endlgrinde\LGend
% switching to u++
...
% switching to sh
\LGinlinefalse\LGbegin\lgrinde
\L{\LB{\V{\$}\0\V{sudo}\0\V{sh}\0\V{u}++\-6.0.0.sh}}
\endlgrinde\LGend
%$
% switching to u++
